...
//  Random WWDC Video
//
//  Created by Thomas Jeans on 4/8/16.
...
class ViewController: NSViewController {
    ...
    @IBAction func refreshButtonPushed(sender: NSButton) {
        sender.image = NSImage(named: "rwv-button-refresh")
        webView.mainFrame.loadRequest(NSURLRequest(URL: NSURL(string: randomURLString)!))
    }
}
